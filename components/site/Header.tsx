...
const labels = {
  RU: {
    catalog: 'Каталог', new: 'Новинки', best: 'Хиты', apparel: 'Одежда', footwear: 'Обувь', accessories: 'Аксессуары', support: 'Поддержка', supportText: 'Поможем подобрать размер и оформить заказ.', account: 'Профиль', menu: 'Открыть меню', close: 'Закрыть меню', cart: 'Открыть корзину', search: 'Поиск товаров', promo: 'Бесплатная доставка от 50 000 ₸', language: 'Язык',
  },
  KZ: {
    catalog: 'Каталог', new: 'Жаңалар', best: 'Хиттер', apparel: 'Киім', footwear: 'Аяқ киім', accessories: 'Аксессуарлар', support: 'Қолдау', supportText: 'Өлшем таңдауға және тапсырыс беруге көмектесеміз.', account: 'Профиль', menu: 'Мәзірді ашу', close: 'Мәзірді жабу', cart: 'Себетті ашу', search: 'Тауар іздеу', promo: '50 000 ₸ бастап тегін жеткізу', language: 'Тіл',
  },
};
