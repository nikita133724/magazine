...
export default function MobileNav() {
  ...
  const l = labels[lang];
  return (
    <div className="fixed inset-x-3 z-[80] rounded-[2rem] border border-slate-200 bg-white/95 px-3 py-2 shadow-2xl shadow-slate-300/50 backdrop-blur-xl md:hidden" style={{ bottom: 'calc(env(safe-area-inset-bottom, 0px) + 12px)', transform: 'translateZ(0)' }}>
